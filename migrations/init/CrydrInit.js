...
export const linkCrydrContracts = async (crydrStorageAddress,
...
export const initCrydr = async (crydrStorageContractArtifact,
  ...
  await linkCrydrContracts(crydrStorageAddress, crydrControllerAddress, crydrViewAddress, crydrViewApiStandardName);
