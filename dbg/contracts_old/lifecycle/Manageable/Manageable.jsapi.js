...
export const enableManager = async (contractAddress, ownerAddress,
  ...
  global.console.log(`\t\tmanagerAddress - ${ManageableArtifact.at(contractAddress)}`);
  ...
  ManageableArtifact.at(contractAddress).then((instance) => {
    instance.enableManager(managerAddress,  {from: ownerAddress });
  });
  ...
  // let instance = await ManageableArtifact.deployed();
    ManageableArtifact.at(contractAddress).then((instance) => {
        for(let i = 0; i < permissionsList.length; i++){
          ...
          instance.grantManagerPermission(managerAddress, permissionName,  {from: ownerAddress});
         }
  });
