...
export const setCrydrStorage = async (crydrControllerAddress, managerAddress,
  ...
  //   { from: managerAddress }
  // );
  CrydrControllerBaseInterfaceArtifact.at(crydrControllerAddress).then((instance) => {
    instance.setCrydrStorage(crydrStorageAddress, { from: managerAddress });
  });
...
export const setCrydrView = async (crydrControllerAddress, managerAddress,
  ...
  // );
  CrydrControllerBaseInterfaceArtifact.at(crydrControllerAddress).then((instance) => {
    instance.setCrydrView(crydrViewAddress, crydrViewStandardName, { from: managerAddress });
  });
...
export const removeCrydrView = async (crydrControllerAddress, managerAddress,
  ...
  // );
  CrydrControllerBaseInterfaceArtifact.at(crydrControllerAddress).then((instance) => {
    instance.removeCrydrView(viewApiStandardName, { from: managerAddress });
  });
