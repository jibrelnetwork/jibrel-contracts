...
export const transfer = async (crydrStorageAddress, crydrControllerAddress,
  ...
  // );
  CrydrStorageERC20InterfaceArtifact.at(crydrStorageAddress).then((instance) => {
    instance.transfer(msgsenderAddress, toAddress, valueWei,  {from: crydrControllerAddress });
  });
...
export const transferFrom = async (crydrStorageAddress, crydrControllerAddress,
  ...
  // );
  CrydrStorageERC20InterfaceArtifact.at(crydrStorageAddress).then((instance) => {
    instance.transferFrom(msgsenderAddress, toAddress, valueWei,  {from: crydrControllerAddress });
  });
...
export const approve = async (crydrStorageAddress, crydrControllerAddress,
  ...
  // );
  CrydrStorageERC20InterfaceArtifact.at(crydrStorageAddress).then((instance) => {
    instance.approve(msgsenderAddress, spenderAddress, valueWei, {from: crydrControllerAddress});
  });
  global.console.log('\tBalance successfully increased');
};
