...
export const setJntController = async (jntPayableServiceAddress, managerAddress,
  ...
  //   { from: managerAddress }
  // );
  JNTPayableServiceInterfaceArtifact.at(jntPayableServiceAddress).then((instance) => {
      instance.setJntController(jntControllerAddress,  {from: managerAddress });
  });
...
export const setJntBeneficiary = async (jntPayableServiceAddress, managerAddress,
  ...
  // );
  JNTPayableServiceInterfaceArtifact.at(jntPayableServiceAddress).then((instance) => {
      instance.setJntBeneficiary(jntBeneficiaryAddress,  {from: managerAddress });
  });
...
export const setActionPrice = async (jntPayableServiceAddress, managerAddress,
  ...
  // );
    JNTPayableServiceInterfaceArtifact.at(jntPayableServiceAddress).then((instance) => {
      instance.setActionPrice(actionName, jntPriceWei,  {from: managerAddress });
  });
