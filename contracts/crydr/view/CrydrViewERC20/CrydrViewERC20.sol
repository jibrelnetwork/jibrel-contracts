...
import '../../controller/CrydrControllerERC20/CrydrControllerERC20Interface.sol';


contract CrydrViewERC20 is
                           CrydrViewBase,
  ...
  function balanceOf(address _owner) external view onlyPayloadSize(1 * 32) returns (uint256) {
